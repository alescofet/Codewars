...
function getHonorPath(honorScore, targetHonorScore) {
    ...
    if (objective % 2 === 0){kyu1=(objective/2)
      }else{kyu2=objective%2;kyu1=(objective-(objective%2))/2}
    if (kyu1 < 0 || kyu2 < 0){kyu1=undefined,kyu2=undefined}
    if (kyu1 === 0 && kyu2 === 0){kyu1=undefined,kyu2=undefined}
  let object = {"1kyus":kyu1, "2kyus":kyu2}
  return (object)
  }